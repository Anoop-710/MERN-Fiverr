      ...
      <div className="left">
          ...
          <div className="reviews">
            ...
            <div className="item">
              ...
              <div className="helpful">
                <span>Helpful?</span>
                <img src="../src/Assets/img/like.png" alt="" />
                <span>Yes</span>
                <img src="../src/Assets/img/dislike.png" alt="" />
                <span>No</span>
              </div>
            </div>
            <hr />
        ...
        <div className="right">
          ...
          <div className="item">
            ...
            <div className="item">
              <img src="../src/Assets/img/recycle.png" alt="" />
              <span>3 Revisions</span>
            </div>
          </div>
          <div className="features">
            <div className="item">
              <img src="../src/Assets/img/greencheck.png" alt="" />
